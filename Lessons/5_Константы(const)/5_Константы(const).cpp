 ...
 * Last Updated: 23 сентября 2025 17:15:04
 * Version: 1.0.33
 */
...
/*
	const - константа, именнованная область оперативной памяти
	предназначенная для хранения постоянных данных, с невозможностью их изменения
*/
